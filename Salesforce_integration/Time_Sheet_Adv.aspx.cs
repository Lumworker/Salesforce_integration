...
{
    public partial class Time_Sheet_Adv : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new ClassBrowseNew().Export_SP_SFTiemSheet_ADV_Prepare("Step2", site_ref);
            ...
            using (ZipFile zip = new ZipFile())
            {
                ...
                string zipName = "Time_Sheet_Adv" + times + ".zip";
