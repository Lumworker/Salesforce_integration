<%@ Page Title="Time Sheet Actual" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Time_Sheet_Actual.aspx.cs" Inherits="Salesforce_integration.Time_Sheet_Actual" %>
                                        ...
                                        <div class="panel-group">
                                            <div class="panel panel-default" style="margin-top: 1em;">
                                                <div class="panel-heading">
                                                    <h4>Import Excel Time Sheet Actual</h4>
                                                </div>
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row" style="margin-bottom: 2rem; margin-top: 2rem;">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12" style="margin-bottom: 2em;">
                                                                <h3 class="control-label">1) เลือก Time Sheet Actual ที่ต้องการ Import </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#nextPage1", function () {
                ...
                LoadFile(excel, site_ref, 'Time_Sheet_Actual');
            });
            ...
            $(document).on("click", "#btn_Download", function () {
                ...
                setTimeout(function () {
                    SP_SFTiemSheet_ACT_Prepare('Step3', site_ref)
                    ...
                    $.ajax({
                        ...
                        success: function (status) {
                            ...
                            if (status == "Error") {
                                ...
                                SP_SFTiemSheet_ACT_Prepare('Step1', site_ref);
                                $('#smartwizard').smartWizard("next");
                            }
                        },
                        error: function () {
            ...
            function SP_SFTiemSheet_ACT_Prepare(Step, site_ref) {
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/SP_SFTiemSheet_ACT_Prepare") %>",
