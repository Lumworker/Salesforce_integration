...
namespace Salesforce_integration
{
    public partial class IcashExport : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new ClassBrowseNew().Export_SP_SFiCash_Transaction_All("Step3", site_ref);
            ...
            string path = Server.MapPath("./Temp/IcashExport/");
            ...
            string excelpath = path + times + ".xls";
                ...
                //Text Path
                    ...
                    using (ZipFile zip = new ZipFile())
                    {
                        ...
                        string zipName = "IcashExport" + times + ".zip";
