<%@ Page Title="Time Sheet Adv" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Time_Sheet_Adv.aspx.cs" Inherits="Salesforce_integration.Time_Sheet_Adv" %>
                                        ...
                                        <div class="panel-group">
                                            <div class="panel panel-default" style="margin-top: 1em;">
                                                <div class="panel-heading">
                                                    <h4>Import Excel Time Sheet Adv</h4>
                                                </div>
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row" style="margin-bottom: 2rem; margin-top: 2rem;">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12" style="margin-bottom: 2em;">
                                                                <h3 class="control-label">1) เลือก Time Sheet Adv ที่ต้องการ Import </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (site_ref != "") {
                ...
                SP_SFTiemSheet_ADV_Prepare('Step0', site_ref)
            }
            else {
            ...
            $(document).on("click", "#nextPage1", function () {
                ...
                LoadFile(excel, site_ref, 'Time_Sheet_Adv');
            });

            $(document).on("click", "#btn_Download", function () {
                $("#MainContent_btnExport").click();
                setTimeout(function () {
                    SP_SFTiemSheet_ADV_Prepare('Step3', site_ref)
            ...
            function LoadFile(data, site_ref, type) {
                ...
                console.log('Time_Sheet_Adv')
                if (type == "Time_Sheet_Adv") {
                    $.ajax({
                        type: 'post',
                        url: './LoadExcel.ashx',
                        data: formData,
                        ...
                        success: function (status) {
                            ...
                            if (status == "Error") {
                                ...
                                SP_SFTiemSheet_ADV_Prepare('Step1', site_ref);
                                $('#smartwizard').smartWizard("next");
                            }
                        },
                        error: function () {
            ...
            function SP_SFTiemSheet_ADV_Prepare(Step, site_ref) {
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/SP_SFTiemSheet_ADV_Prepare") %>",
