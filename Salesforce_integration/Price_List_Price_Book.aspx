<%@ Page Title="Price List Price Book" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Price_List_Price_Book.aspx.cs" Inherits="Salesforce_integration.Price_List_Price_Book" %>
                                        ...
                                        <div class="panel-group">
                                            <div class="panel panel-default" style="margin-top: 1em;">
                                                <div class="panel-heading">
                                                    <h4>Import Excel Price List Price Book</h4>
                                                </div>
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row" style="margin-bottom: 2rem; margin-top: 2rem;">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12" style="margin-bottom: 2em;">
                                                                <h3 class="control-label">1) เลือก Price List Price Book ที่ต้องการ Import </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#nextPage1", function () {
                ...
                LoadFile(excel, site_ref, 'Price_List_Price_Book');
            });
            ...
            //    setTimeout(function () {
            //        SP_SFPriceList_Price_Book('Step3', site_ref)
                    ...
                    $.ajax({
                        ...
                        success: function (status) {
                            ...
                            if (status == "Error") {
                                ...
                                SP_SFPriceList_Price_Book('Step1', site_ref);
                                $('#smartwizard').smartWizard("next");
                                $("#Step1_fileUpload").attr("disabled", true)
                                $("#nextPage1").attr("disabled", true)
            ...
            function SP_SFPriceList_Price_Book(Step, site_ref) {
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/SP_SFPriceList_Price_Book") %>",
