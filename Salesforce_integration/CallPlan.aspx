<%@ Page Title="Icash Export" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallPlan.aspx.cs" Inherits="Salesforce_integration.IcashExport" %>
    ...
    <div class="panel-group">
        <div class="panel-body">
            <div class="row">
                <div id="smartwizard">
                    <ul>
                        <li class="check" data-step="Step1"><a href="#step-1">Import Plan</a></li>
                        <li class="check" data-step="Step2"><a href="#step-2">Import Actual</a></li>
                        <li class="check" data-step="Step3"><a href="#step-3">Export File Excel & Notepad</a></li>
                                                    ...
                                                    <div class="row" style="margin-bottom: 2rem; margin-top: 2rem;">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12" style="margin-bottom: 2em;">
                                                                <h3 class="control-label">1) เลือก Call Plan ที่ต้องการ Import </h3>
                                            ...
                                            <div class="panel panel-default" style="margin-top: 1em;">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row" style="margin-bottom: 2rem; margin-top: 2rem;">
                                                        <div class="col-md-12">
                                                            <div class="col-md-12" style="margin-bottom: 2em;">
                                                                <h3 class="control-label">2) เลือกไฟล์ Actual ที่ต้องการ Import </h3>
                                                    ...
                                                    <div style="text-align: right; margin: 1rem;">
                                                        <button id="nextPage2" class="btn btn-warning Pos_Viewer" type="button" data-toggle="modal" style="text-align: left; margin-top: 2rem; display: none;">Next</button>
                                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row" style="margin-bottom: 2rem; margin-top: 2rem;">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12" style="margin-bottom: 2em;">
                                                    <h3 class="control-label">3) Export File Excel & Notepad </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (site_ref != "") {
                ...
                SP_SFiCash_Transaction_All('Step0', site_ref)
            }
            else {
            ...
            $(document).on("click", "#nextPage2", function () {
                ...
                LoadFile(excel, site_ref, 'Actual');
            });
            ...
            $(document).on("click", "#btn_Download", function () {
                ...
                setTimeout(function () {
                    SP_SFiCash_Transaction_All('Step3.5', site_ref)
                    $('#smartwizard').smartWizard("next");
                    $("#btn_Download").attr("disabled", true)
                    $("#Step1_fileUpload").attr("disabled", true)
                    $("#Step2_fileUpload").attr("disabled", true)
                    ...
                    $.ajax({
                        ...
                        success: function (status) {
                            ...
                            if (status == "Error") {
                                ...
                                SP_SFiCash_Transaction_All('Step1', site_ref);
                                $('#smartwizard').smartWizard("next");
                            }
                        },
                        error: function () {
                    ...
                    $.ajax({
                        ...
                        success: function (status) {
                            ...
                            if (status == "Error") {
                                ...
                                SP_SFiCash_Transaction_All('Step2', site_ref);
                                SP_SFiCash_Transaction_All('Step2.5', site_ref);
                                $('#smartwizard').smartWizard("next");
                            }
                        },
                        error: function () {
            ...
            function SP_SFiCash_Transaction_All(Step, site_ref) {
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/SP_SFiCash_Transaction_All") %>",
